...
if __name__ == '__main__':
    ...
    de = RDFDH(mol, "MP2").polar_method().run().pol_tot
    ...
    de = RDFDH(mol, xc).polar_method().run().pol_tot
    print(np.allclose(nde, de, atol=1e-5, rtol=1e-4), abs(nde - de).max())
